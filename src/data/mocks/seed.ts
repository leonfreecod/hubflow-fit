...
export const workoutsSeed: WorkoutPlan[] = [
  {
    ...
    objective: 'Velocidade e resistência',
    level: 'INTERMEDIATE',
    weeks: 8,
    sessionsPerWeek: 4,
    assignedStudentIds: ['student-001', 'student-003'],
    updatedAt: '2026-07-22',
    description: 'Ciclo progressivo com intervalados, tempo run, rodagem leve e longão.',
  },
  {
    id: 'workout-002',
    name: 'Força Essencial',
    objective: 'Força geral e estabilidade',
    level: 'BEGINNER',
    weeks: 6,
    sessionsPerWeek: 3,
    assignedStudentIds: ['student-002', 'student-004'],
    updatedAt: '2026-07-20',
    description: 'Base de movimentos fundamentais, mobilidade e progressão semanal.',
  },
  {
    id: 'workout-003',
    name: 'Meia Maratona Base',
    objective: 'Construção de volume',
    level: 'INTERMEDIATE',
    weeks: 12,
    sessionsPerWeek: 5,
    assignedStudentIds: ['student-003'],
    updatedAt: '2026-07-18',
    description: 'Bloco de base aeróbia para preparação segura da primeira meia maratona.',
  },
  {
    id: 'workout-004',
    name: 'Mobilidade & Condicionamento',
    objective: 'Mobilidade e resistência',
    level: 'BEGINNER',
    weeks: 4,
    sessionsPerWeek: 3,
    assignedStudentIds: ['student-005'],
